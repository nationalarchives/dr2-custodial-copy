...
object Dependencies {
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.48-SNAPSHOT"
  ...
  lazy val sqsClient = "uk.gov.nationalarchives" %% "da-sqs-client" % "0.1.33-SNAPSHOT"
