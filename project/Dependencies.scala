import sbt.*
object Dependencies {
  private lazy val daAwsClientsVersion = "0.1.85"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.100"
  ...
  lazy val sqlite = "org.xerial" % "sqlite-jdbc" % "3.46.1.1"
}
