import sbt.*
object Dependencies {
  private lazy val daAwsClientsVersion = "0.1.102"
  private lazy val logbackVersion = "2.24.2"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.112"
