import sbt.*
object Dependencies {
  private lazy val daAwsClientsVersion = "0.1.140"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.157"
  ...
  lazy val doobieCore = "org.tpolecat" %% "doobie-core" % "1.0.0-RC11"
  lazy val sqlite = "org.xerial" % "sqlite-jdbc" % "3.51.1.0"
}
