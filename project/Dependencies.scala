import sbt.*
object Dependencies {
  private lazy val daAwsClientsVersion = "0.1.68"
  ...
  private lazy val http4sVersion = "1.0.0-M29"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.85"
  ...
  lazy val doobieCore = "org.tpolecat" %% "doobie-core" % "1.0.0-RC4"
